...
import com.javaer.plusxposed.libs.flyco.animation.BounceEnter.BounceLeftEnter;
import com.javaer.plusxposed.libs.flyco.animation.FadeExit.FadeExit;
import com.javaer.plusxposed.libs.flyco.dialog.utils.CornerUtils;
import com.javaer.plusxposed.libs.flyco.dialog.utils.StatusBarUtils;
import com.javaer.plusxposed.libs.flyco.dialog.view.TriangleView;
...
public abstract class BaseBubblePopup<T extends BaseBubblePopup<T>> extends InternalBasePopup<T> {
    ...
    public View onCreateView() {
        ...
        mLlContent = (LinearLayout) inflate.findViewById(80000);
        mTriangleView = (TriangleView) inflate.findViewById(80001);
