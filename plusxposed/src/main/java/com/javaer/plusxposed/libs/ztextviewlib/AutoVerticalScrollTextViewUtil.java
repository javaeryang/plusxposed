package com.javaer.plusxposed.libs.ztextviewlib;
...
/**
 *  用来管理 AutoVerticalScrollTextView
 *  Created by on 2017/6/30.
 */
public class AutoVerticalScrollTextViewUtil {
    ...
    // 设置字体颜色
    public AutoVerticalScrollTextViewUtil setTextColor(int textColor) {
